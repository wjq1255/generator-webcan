...
!function (loft) {
    loft.require = require;
    loft.define = define;

    /**
     * @since V1.0.1
     * @method require
     * require方法挂在loft这个全局单例静态对象上，更有面向对象的感觉。
     */
    /**
     * @since V1.4.3
     * @method define
     * define方法挂在loft这个全局单例静态对象上，更有面向对象的感觉。
     */
}(loft);
/**
 * Title: loft.i18n.js
 * Description: loft.i18n.js
 * Author: huang.jc
 * Created Date: 15-2-24 下午4:42
...
define('i18n',['module'], function(module) {
  return {
    ...
    load: function(name, req, onLoad, config) {
      var toLoad = [];
      var loc = "en";
      if(loft&&loft.language){//window.loft肯定是存在的
        loc = loft.language;
      } else {
...
/**
 * Created by huangjc on 2015/6/16.
 */
